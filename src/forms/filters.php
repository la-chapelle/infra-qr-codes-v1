						...
						<div class="row">
							...
							<div class="col-5 col-md-2">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="<?php echo $langArray['Search']; ?>" id="input_search" name="search_str" value="<?php echo htmlspecialchars($search_str??'', ENT_QUOTES, 'UTF-8'); ?>">
