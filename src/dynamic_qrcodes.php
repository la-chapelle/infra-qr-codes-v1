...
<div class="wrapper">
  ...
  <div class="content-header">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
      <h1 class="m-0 text-dark"><?php echo $langArray['Dynamic Qr codes']; ?></h1>
      </div><!-- /.col -->
      
      <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item">
          <a href="dynamic_qrcode.php" class="btn btn-success"><i class="fa fa-plus"></i> <?php echo $langArray['Add new']; ?></a>
        </li>
      </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
